...
public class Main{
    public static void main(String[] args){
        ...
        Sala sala3 = new Sala("Bloco 2 - sala 1","Carros V");
        ...
        String op = "S";
            ...
            do {
                try {
                    ...
                    int bloco = 0;
                    int sala = 0;
                    System.out.printf("%n%n=========================== TeleCine ===========================%n");
                    ...
                    while (sala > cinema.length || sala <= 0) {
                        System.out.printf("Digite uma sala válida entre 1 e %d: ", cinema.length);
                        sala = sc.nextInt();
                    }
                    --sala;
                    ...
                    System.out.println("Informação inserida incorretamente - err "+e.getMessage());
                }
